...
<div class="container">
    ...
    <div class="mt-3">
        <a href="/BT_jv4_12th3_war_exploded/kich-thuoc/create"><button type="button" class="btn btn-primary">Thêm Kích Thước</button> </a>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-primary">
            ...
            <tbody>
            <c:forEach items="${ds}" var="kts">
                <tr>
                    <td>${kts.id}</td>
                    <td>${kts.ma}</td>
                    <td>${kts.ten}</td>
                    <td>${kts.trangThai == 1 ? "Hoat Dong" : "Ngung Hoat Dong"}</td>
                    <td>
                        <a href="/BT_jv4_12th3_war_exploded/kich-thuoc/edit?id=${kts.id}">
                            <button type="button" class="btn btn-info">Update</button></a>
                        <a href="/BT_jv4_12th3_war_exploded/kich-thuoc/delete?id=${kts.id}">
