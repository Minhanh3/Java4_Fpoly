...
<div class="container">
    ...
    <form action="/BT_jv4_12th3_war_exploded/kich-thuoc/store" method="post">
        ...
        <div class="mt-3">
            <a href="/BT_jv4_12th3_war_exploded/kich-thuoc/index"><button type="button" class="btn btn-primary">Quay Lại</button> </a>
