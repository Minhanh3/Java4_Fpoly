...
<div class="container">
    <h2>Thêm Màu Sắc</h2>
    <form action="/BT_jv4_12th3_war_exploded/mau-sac/store" method="post">
        ...
        <div class="mt-3">
            <a href="/BT_jv4_12th3_war_exploded/mau-sac/index"><button type="button" class="btn btn-primary">Quay Lại</button> </a>
