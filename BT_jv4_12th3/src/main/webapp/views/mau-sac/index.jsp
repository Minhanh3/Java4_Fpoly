...
<div class="container">
    ...
    <div class="mt-3">
        <a href="/BT_jv4_12th3_war_exploded/mau-sac/create">
            <button type="button" class="btn btn-primary">Thêm Màu Sắc</button>
        </a>
    </div>
        ...
        <table class="table table-primary">
            ...
            <c:forEach items="${ds}" var="ms">
                <tr>
                    ...
                    <td>
                        <a href="/BT_jv4_12th3_war_exploded/mau-sac/edit?id=${ms.id}">
                            <button type="button" class="btn btn-info">Update</button>
                        </a>
                        <a href="/BT_jv4_12th3_war_exploded/mau-sac/delete?id=${ms.id}">
