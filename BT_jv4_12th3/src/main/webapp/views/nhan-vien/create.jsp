...
<div class="container">
    ...
    <form action="/BT_jv4_12th3_war_exploded/nhan-vien/store" method="post">
        <div class="mb-3 col-7">
            <label for="" class="form-label">Tên</label>
            <input type="text" name="ten" class="form-control aria-describedby=" helpId" />
            <div class="form-text text-danger">${err.ten}</div>
        </div>
        <div class="mb-3 col-7">
            <label for="" class="form-label">Mã NV</label>
            <input type="text" name="ma" class="form-control" aria-describedby="helpId"/>
            <div class="form-text text-danger">${err.ma}</div>
        </div>
        <div class="mb-3 col-7">
            <label for="" class="form-label">Tên Đăng Nhập</label>
            <input type="text" name="tenDangNhap" class="form-control aria-describedby=" helpId" />
            <div class="form-text text-danger">${err.tenDangNhap}</div>
        </div>
        <div class="mb-3 col-7">
            <label for="" class="form-label">Mật Khẩu</label>
            <input type="password" name="matKhau" class="form-control aria-describedby=" helpId" />
        ...
        <div class="mt-3">
            <a href="/BT_jv4_12th3_war_exploded/nhan-vien/index">
