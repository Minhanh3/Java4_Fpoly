...
<div class="container">
    ...
    <div class="mt-3">
        <a href="/BT_jv4_12th3_war_exploded/nhan-vien/create"><button type="button" class="btn btn-primary">Thêm Nhân Viên</button> </a>
    </div>
        ...
        <table class="table table-primary">
            ...
            <c:forEach items="${ds}" var="nv">
                <tr>
                    ...
                    <td>${nv.matKhau}</td>
                    <td>${nv.trangThai == 1 ? "Hoat Dong" : "Ngung Hoat Dong"}</td>
                    <td>
                        <a href="/BT_jv4_12th3_war_exploded/nhan-vien/edit?id=${nv.id}">
                            <button type="button" class="btn btn-info">Update</button></a>
                        <a href="/BT_jv4_12th3_war_exploded/nhan-vien/delete?id=${nv.id}">
