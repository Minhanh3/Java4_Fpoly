...
<div class="container">
    ...
    <a href="/BT_jv4_12th3_war_exploded/">
        <button type="button" class="btn btn-primary">Quay Lại</button>
    </a>
    <a href="/BT_jv4_12th3_war_exploded/san-pham/create">
        ...
        <table class="table table-primary">
            ...
            <c:forEach items="${ds}" var="ms">
                <tr>
                    ...
                    <td>
                        <a href="/BT_jv4_12th3_war_exploded/sp-chitiet/create?IdSanPham=${ms.id}">
                            <button type="button" class="btn btn-primary">Thêm SPCT</button>
                        </a>
                        <a href="/BT_jv4_12th3_war_exploded/san-pham/edit?id=${ms.id}">
                            <button type="button" class="btn btn-info">Update</button>
                        </a>
                        <a href="/BT_jv4_12th3_war_exploded/san-pham/delete?id=${ms.id}">
