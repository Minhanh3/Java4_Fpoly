...
<div class="container mt-4">
    ...
    <div class="mt-3">
        <a href="/BT_jv4_12th3_war_exploded/hoa-don-chitiet/create"><button type="button" class="btn btn-primary">Thêm Hóa Đơn Chi Tiết</button> </a>
    </div>
        ...
        <table class="table table-primary">
            ...
            <c:forEach items="${ds}" var="ms">
                <tr>
                    ...
                    <td>${ms.soLuong}</td>
                    <td>${ms.donGia}</td>
                    <td><fmt:formatDate value="${ms.thoiGian}" pattern="dd/MM/yyyy"/></td>
                    <td>${ms.trangThai}</td>
                    <td>
                        <a href="/BT_jv4_12th3_war_exploded/hoa-don-chitiet/edit?id=${ms.id}">
                            <button type="button" class="btn btn-info">Update</button></a>
                        <a href="/BT_jv4_12th3_war_exploded/hoa-don-chitiet/delete?id=${ms.id}">
