...
<div class="container">
    ...
    <form action="/BT_jv4_12th3_war_exploded/hoa-don-chitiet/store" method="post">
        <div class="mb-3 col-7">
            <label for="" class="form-label">id HoaDon</label>
            <input type="text" name="idHoaDon" class="form-control" aria-describedby="helpId"/>
            <div class="form-text text-danger">${err.idHoaDon}</div>
        </div>
        <div class="mb-3 col-7">
            <label for="" class="form-label">id SPCT</label>
            <input type="text" name="idSPCT" class="form-control" aria-describedby="helpId"/>
        ...
        <div class="mb-3 col-7">
            ...
            <input type="date" name="thoiGian" class="form-control aria-describedby=" helpId" />
