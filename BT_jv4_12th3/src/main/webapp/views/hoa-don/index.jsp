...
<div class="container mt-4">
    ...
    <div class="mt-3">
        <a  href="/BT_jv4_12th3_war_exploded/hoa-don/create"><button type="button" class="btn btn-primary">Thêm Hóa Đơn</button> </a>
    </div>
        ...
        <table class="table table-primary">
            ...
            <c:forEach items="${ds}" var="ms">
                <tr>
                    ...
                    <td>
                        <a href="/BT_jv4_12th3_war_exploded/hoa-don/edit?id=${ms.id}"><button type="button" class="btn btn-info">Update</button ></a>

                        <a href="/BT_jv4_12th3_war_exploded/hoa-don/delete?id=${ms.id}"><button type="button" class="btn btn-danger">Delete</button></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
