...
<div class="container">
    ...
    <form action="/BT_jv4_12th3_war_exploded/hoa-don/update" method="post">
        <div class="mb-3 col-7">
            <label for="" class="form-label">ID</label>
            <input type="text" name="id" value="${h.id}" class="form-control" aria-describedby="helpId" disabled/>
        </div>
        <div class="mb-3 col-7">
            <label for="" class="form-label">id NhanVien</label>
            <input type="text" name="idNhanVien" value="${h.idNhanVien}" class="form-control"
                   aria-describedby="helpId"/>
            <div class="form-text text-danger">${err.idNhanVien}</div>
        </div>
        <div class="mb-3 col-7">
            <label for="" class="form-label">id KhachHang</label>
            <input type="text" name="idKhachHang" value="${h.idKhachHang}" class="form-control"
                   aria-describedby="helpId"/>
            <div class="form-text text-danger">${err.idKhachHang}</div>
        </div>
        <div class="mb-3 col-7">
            <label for="" class="form-label">Ngay Mua Hang</label>
            <input type="date" name="ngayMuaHang" value="${h.ngayMuaHang}" class="form-control aria-describedby=" helpId"
            />
            <div class="form-text text-danger">${err.ngayMuaHang}</div>
        </div>
        <label for="" class="form-label">Trang thai</label>
        <div class="form-check">
            <input class="form-check-input" ${h.trangThai==1 ? "checked" : "" } type="radio" name="trangThai" value="1"
                   checked>
        ...
        <div class="form-check">
            <input class="form-check-input" ${h.trangThai==0 ? "checked" : "" } type="radio" name="trangThai" value="0"
                   checked>
            <label class="form-check-label" for="">
                Ngung Hoat Dong
            </label>
